<x-main-layout title="URABOROS">
    <div class="max-w-4xl mx-auto bg-gray-800 rounded-xl shadow-2xl p-6 border border-gray-700">
        <h1 class="text-4xl font-bold mb-6 text-center text-indigo-400">TELEGRAM WORD</h1>
        ...
        <div class="space-y-6">
            <div class="bg-gray-700 p-4 rounded-lg">
                <form action="{{ route('telegram.search-word-group.result') }}" method="GET" class="space-y-4">
                    ...
                    <div>
                        <label for="query" class="block text-sm font-medium text-gray-300 mb-1">Поисковый
                            запрос</label>
